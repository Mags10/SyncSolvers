...
addObject(block, 876, 420);
block = new Block(168, 24);
addObject(block, 1764, 420);
block = new Block(24, 24);
addObject(block, 1140, 444);
block = new Block(24, 24);
addObject(block, 1140, 468);
block = new Block(24, 24);
addObject(block, 1140, 492);
...
peak = new Obstacle();
addObject(peak, 1332, 324);
peak = new Obstacle();
addObject(peak, 1356, 324);
peak = new Obstacle();
